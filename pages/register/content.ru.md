...
## Билет с проживанием стоит 22 000 рублей

В стоимость билета входит:

• участие в конференции (2 дня);

• проживание в трехместном номере в отеле [«PineRiver»](http://pineriver.ru) (6 минут на машине от места проведения конференции);
