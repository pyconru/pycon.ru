...
Доклад будет полезен Python-программистам, желающим познакомиться с возможностями Tornado, а также разработчикам распределенных систем, решающим проблемы организации взаимодействия между компонентамими.
</div>
