...
<a name="kukushkin"></a>![kukushkin](https://img-fotki.yandex.ru/get/48627/121639917.dd/0_15bf1a_78378ecd_orig) Дмитрий Кукушкин, Минск
>
> Разработчик на питоне около 7 лет. Последний год занимается Full Stack разработкой в компании [Wargaming.net](http://wargaming.com/ru/) на проекте Wolrd Of Tanks Global Map. Интересуется GIS и функциональным программированием.
