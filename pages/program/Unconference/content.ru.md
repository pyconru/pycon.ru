...
speaker: |
    **Дмитрий Киселев**, Endpoint.com, Екатеринбург
    
title: "Docker-compose + ROS + roslibjs + Selenium и тетирование распределенных систем"
...
speaker: |
    **Ринат Хабибиев**, Redmadrobot, Москва
    
title: "Автоматизация деплоя Docker контейнеров"
